...
def create_calibration_dataset(cocoGt, model_detections, filename, dataset_classes, num_images=458):
    all_detections = []
    num_classes = len(dataset_classes)
    breakpoint()
...
def calibration_error(predicted_ious, det_ious, bin_count=25, num_cl=15):
...
if __name__ == '__main__':
    ...
    val_file = '/ext/lx/dota/val/DOTA_1.0.json'
    test_file = '/ext/lx/dota/val/DOTA_1.0.json'
    ...
    if class_agnostic_calibration:
        calibration_file = "calibration/" + model_name + "/calibrators/" + calibration_type + '_class_agnostic_finaldets458.pkl'
    else:
        calibration_file = "calibration/" + model_name + "/calibrators/" + calibration_type + '_class_wise_finaldets458.pkl'
